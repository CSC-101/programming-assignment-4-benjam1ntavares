...
# Slo Data is sample data representing one CountyDemographics datapoint in list format
...
# Reduced data is a reduced version of county_demographics.data used to simplify testing
reduced_data = [
